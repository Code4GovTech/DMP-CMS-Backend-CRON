        ...
        for dmp in dmp_tickets:
            ...
            async with httpx.AsyncClient() as client:
                ...
                if issue_response.status_code == 200:
                    ...
                    update_data = await DmpCronQueries.update_dmp_issue(async_session,issue_id=dmp_id, update_data=issue_update)
                ...
                async with httpx.AsyncClient() as client:
                    ...
                    if comments_response.status_code == 200:
                        ...
                        for val in comments_response.json():
                            ...
                            #get created_at                 
                            created_timestamp = await DmpCronQueries.get_timestamp(async_session, DmpIssueUpdates, 'created_at', 'comment_id', comment_update['comment_id'])
                ...
                if pr_response.status_code == 200:
                    ...
                    for pr_val in pr_response.json():
                        ...
                        if (pr_created_at >= TARGET_DATE):
                            ...
                            created_timestamp =  await DmpCronQueries.get_timestamp(async_session, DmpPrUpdates,'created_at','pr_id',pr_data['pr_id'])
